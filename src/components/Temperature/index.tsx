...
export function Temperature ({local,actualDegrees,maxDegrees,minDegrees,windAmount, rainAmount,humityAmount}:TemperatureProps){
    return(
        <section id='temperature-now' className={"grid grid-cols-1 sm:min-h-[40px] before:content-[''] before:w-[17.6rem]  before:absolute before:top-[-5.6rem]  before:left-[-1.6rem] sm:before:left-[-5.6rem] before:h-[17.6rem] before:bg-[url(../assets/clouds.svg)]  h-max bg-[url(../assets/bg-temp-now.jpeg)] auto-cols-max"}>
